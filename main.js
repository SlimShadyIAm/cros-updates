...
const rolesToPing = [
	{ name: "Stable updates", id: "550382017213104147" },
	{ name: "Beta updates", id: "550401535578996754" },
	{ name: "Dev updates", id: "550401653732540417" }
];
...
watcher.on("new entries", function(entries) {
	...
	entries.forEach(function(entry) {
		if (entry.categories.includes("Chrome OS")) {
			// filter out non-Chrome OS related posts
			console.log(
